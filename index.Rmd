...
Soit la fonction $p_\Sigma \left( \boldsymbol{\pi} \right)$ représentant le profit total du
portefeuille où
$$p_\Sigma \left( \boldsymbol{\pi} \right) = \sum\limits_{i = 1}^{n} p_i \left( \pi_i \right)$$
...
Soit la fonction $\gamma_i \left( \pi_i \right)$ représentant la probabilité que le client $i$
accepte l'offre de prime $\pi_i$

--

Soit la fonction $\tilde{p_i} \left( \pi_i \right)$ représentant le profit espéré pour le client $i$
où
$$\tilde{p_i} \left( \pi_i \right) = \gamma_i \left( \pi_i \right) * p_i \left( \pi_i \right)$$

--

Soit la fonction $\gamma_\Sigma \left( \boldsymbol{\pi} \right)$ représentant le taux de conversion
du portefeuille où
$$\gamma_\Sigma \left( \boldsymbol{\pi} \right) = \frac{\sum\limits_{i = 1}^{n} \gamma_i \left( \pi_i \right)}{n}$$
